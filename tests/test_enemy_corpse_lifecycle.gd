...
func _initialize() -> void:
	...
	_assert_false(enemy.get_collision_layer_value(1), "settled corpse does not trap the player")
	_assert_false(enemy.get_collision_mask_value(1), "settled corpse disables physical collision sensing")
